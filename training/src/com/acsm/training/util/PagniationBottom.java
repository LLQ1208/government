...
//		stringBuilder.append("<div class='pagination input-sm pull-left' style='margin-left:5px;color:#ffffff;'>");
//			stringBuilder.append("<span data-i18n='table.page.perpage'>Results Per Page: </span> ");
//			if(pageHelper.getPageSize()==10){
//				stringBuilder.append("<a data-currentpage='1' data-pagesize='10' class='label label-success page-click' href=\"javascript:\">10</a> ");
//			}else{
//				stringBuilder.append("<a data-currentpage='1' data-pagesize='10' class='page-click'>10</a> ");
//			}
//			
//			stringBuilder.append(" | ");
//			
//			if(pageHelper.getPageSize()==20){
//				stringBuilder.append("<a data-currentpage='1' data-pagesize='20' class='label label-success page-click' href=\"javascript:\">20</a> ");
//			}else{
//				stringBuilder.append("<a data-currentpage='1' data-pagesize='20' class='page-click'>20</a> ");
//			}
//			
//			stringBuilder.append(" | ");
//			
//			if(pageHelper.getPageSize()==50){
//				stringBuilder.append("<a data-currentpage='1' data-pagesize='50' class='label label-success page-click' href=\"javascript:\">50</a> ");
//			}else{
//				stringBuilder.append("<a data-currentpage='1' data-pagesize='50' class='page-click'>50</a> ");
//			}
//			stringBuilder.append("<span data-i18n='table.page.current' style='padding-left:10px;'>Current: </span>");
