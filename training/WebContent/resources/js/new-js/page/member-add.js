...
$(function () {
    ...
    $(".cancel-btn").on("click",function(){
        var ctx = $("#ctx").val();
        window.location.href = ctx + "/memberNew/memberList";
    });
});
function toDou(n) {
    return n > 9 ? n : '0' + n;
...
function save(){
    ...
    if(templateId == '0'){
        ...
        if(customType == "2"){
            ...
            if(countType == '1'){//团课卡
                ...
                json = {memberName:memberName,phone:phone,box:box,templateId:templateId,
                    customType:customType,beginTime:beginTime,endTime:endTime,money:money,
                    bountType:countType,courseTypeIds:courseTypeIds};
    ...
    var isExist = false;
    $.ajax({
        url: ctx + "/memberNew/memberAddCheck",
        type: 'POST', //GET
