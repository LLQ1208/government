...
<body>
	<div class="memberBanner">
		...
		<div class="content">
			<div class="searchLine clearfix">
			    ...
			    <a href="${ctx}/setting/supporter/add" class="btn-c fr">添加</a>
			</div>
						...
						<c:forEach items="${pager.list}" var="item">
							<tr>
								...
								<td>
									...
									<a href="${ctx}/setting/supporter/edit/${item.id}" class="btn-b fr edit">编辑</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
	...
	<script type="text/javascript">
		$(function(){
			(new crossfit.cfer.supporter.supporterList()).init();
		});
	</script>
</body>
</html>