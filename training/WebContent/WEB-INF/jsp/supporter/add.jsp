	...
	<div class="content" style="margin-top:50px;">
		...
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="phone" value="" class="srk fl type-name">
				</div>
			</div>
		...
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="email" value="" class="srk fl type-name">
				</div>
			</div>
		...
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="userName" value="" class="srk fl type-name">
				</div>
			</div>
		...
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="password" value="" class="srk fl type-name">
				</div>
			</div>
