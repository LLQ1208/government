...
<body>
	...
	<div class="content" style="margin-top:50px;">
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="name" value="${courseType.name}" class="srk fl type-name">
				</div>
			</div>
		...
		<div id="course-level">
			<c:forEach items="${courseType.levelList}" var="level">
				<div class="row item">
					<div class="col-sm-12 fl">
						<div class="col-sm-3 input-item text-center">等级</div>
						<div class="col-sm-6">
							<input type="text" value="${level}" class="srk fl level">
						</div>
						<div class="col-sm-2">
	...
	<input type="hidden" id="id" value="${courseType.id}"/>
