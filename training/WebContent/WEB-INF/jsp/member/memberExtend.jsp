...
<div class="content-box">
    ...
    <div class="main-content">
        <form:form method="post" id="boxInformation" name="boxInformation" action="${ctx}/memberNew/memberExtendSave" commandName="memberModel" enctype="multipart/form-data">
           <input type="hidden" name="memberId" id="memberId" value="${member.id}">
            <div class="member-add">
                <div id="bread" class="clearfix">
                    ...
                    <span class="breadThird">添加月卡会员</span>
                </div>
                <div class="member-detail clearfix">
                    <div class="member-base fl">
                        <div class="head-input">
                            <div class="traningLogo" id="traningLogo" style="background-size: 100%;width: 120px;height: 120px;" >
                                <c:choose>
                                    <c:when test="${member.avatar == null || member.avatar == ''}">
                                        <img src="${ctx}/resources/images/new-image/no_pic.png" id="imghead" class="fl" alt="" style="width: 60px;height: 60px;border-radius: 50%;margin-right: 18px;">
                                    </c:when>
                                    <c:otherwise>
                                        <img src="${member.avatar}" id="imghead" class="fl" alt="" style="width: 120px;height: 120px;border-radius: 50%;margin-right: 18px;">
                                    </c:otherwise>
                                </c:choose>
                            </div>
                            <input type="file" id="img" name="img" style="cursor: pointer;" onchange="previewImage(this);" accept="image/gif,image/jpg,image/png"/>
                        </div>
                        <div class="sex">
                            <span>性别</span>
                            <c:choose>
                            ...
                            <c:choose>
                                <c:when test="${member.sex == 1}">
                                    <input type="radio" class="female" name="sex"  checked value="1">
                                </c:when>
                                <c:otherwise>
                        ...
                        <div class="birth-box clearfix">
                            <c:choose>
                                <c:when test="${member.birthday == null || member.birthday == ''}">
                                    <input size="16" type="text" value="" readonly class="form-datetime" style="text-align: center;cursor: pointer;" id="birthday" name="birthday">                                </c:when>
                                <c:otherwise>
                                    <input size="16" type="text" value="<fmt:formatDate value="${member.birthday}" pattern="yyyy-MM-dd"/>" readonly class="form-datetime" style="text-align: center;cursor: pointer;" id="birthday" name="birthday">
                                </c:otherwise>
                            </c:choose>
                            <p>出生年月</p>
                        </div>
                    ...
                    <div class="member-info fl">
                        <div class="member-info-box">
                            <input type="text" value="${member.name}" placeholder="请输入会员姓名" maxlength="10" id="memberName" name="memberName">
                            <p>姓名</p>
                        </div>
                        <div class="member-info-box">
                            <input type="text" value="${member.phone}" placeholder="请输入会员手机号" id="phone" readonly maxlength="20" name="phone">
                            <p>手机号</p>
                        </div>
                        <div class="member-info-box">
                            <input type="text" value="${member.email}" placeholder="请输入会员电子邮箱" id="email" name="email" maxlength="50">
                            <p>电子邮箱</p>
                        </div>
                        <div class="member-info-box">
                            <select  id="box" name="box">
                                <c:forEach items="${boxList}" var="box">
                                    <c:choose>
                                        <c:when test="${member.boxId == box.id}">
...
<script src="${ctx}/resources/js/new-js/page/memberExtend.js"></script>
</html>