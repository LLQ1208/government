...
<body>
    <div class="main-content" style="width: 122px;height: 208px">
        <form:form method="post" id="boxInformation" name="boxInformation" action="${ctx}/memberNew/memberImgSave" commandName="memberModel" enctype="multipart/form-data">
            <div class="left fl">
            ...
            <input value="${member.id}" id="memberId" type="hidden" name = "memberId">
...
<script src="${ctx}/resources/js/new-js/page/member-view-iframe.js"></script>
</html>