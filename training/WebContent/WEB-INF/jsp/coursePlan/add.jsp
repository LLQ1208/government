	...
	<c:choose>
		<c:when test="${fn:length(courseTypeList) eq 0}">
			<div class="content" style="margin-top:50px;">
				<div class="text-center" style="font-size:16px;">无可选课程类型，请先课程类型管理页添加课程类型，<a href="${ctx}/setting/courseType" style="color:#ff0000;">点击跳转到课程类型管理</a></div>
			</div>
		</c:when>
		<c:otherwise>
			<div class="content" style="margin-top:50px;">
				...
				<div class="row item">
					<div class="col-sm-12 fl">
						...
						<div class="col-sm-8">
							<input class="srk type-name" id="peopleLimit" type="number" value="10" min="1">
						</div>
					</div>
				</div>
				<div class="row item">
					<div class="col-sm-12 fl">
						...
						<div class="col-sm-3">
							<input class="srk training-time" id="startTime"/>
						</div>
					    <div class="col-sm-1" style="font-size:16px;margin-top:12px;">-</div>
					    <div class="col-sm-3">
					    	<input class="srk training-time" id="endTime"/>
					    </div>
					</div>
