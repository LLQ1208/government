	...
	<div class="content" style="margin-top:50px;">
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="name" value="${coach.name}" class="srk fl coach-item">
				</div>
			</div>
		...
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="phone" value="${coach.phone}" class="srk fl coach-item">
				</div>
			</div>
		...
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="userName" value="${user.userName}" class="srk fl coach-item">
				</div>
			</div>
		...
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="password" value="${user.password}" class="srk fl coach-item">
				</div>
			</div>
		...
		<div class="row item">
			<div class="col-sm-12 fl">
				...
				<div class="col-sm-5">
					<input type="text" id="level" value="${coach.level}" class="srk fl coach-item">
				</div>
			</div>
