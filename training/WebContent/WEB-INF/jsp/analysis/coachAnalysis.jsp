...
<jsp:include page="../menu.jsp" flush="false" >
    <jsp:param value="coachAnalysis" name="menuName"/>
...
<div class="order">
    ...
    <div class="statistic-box">
        ...
        <div class="position-block clearfix">
            ...
            <div class="position-box fl">
            <select id="courseType" class="position-select"  onchange="getSource()">
                <option value="1" selected = "selected">团课</option>
...
<script src="${ctx}/resources/js/new-js/page/coach-statistic.js"></script>
</html>